package Moudle.Spark1.sxt.cong.streaming;//package com.cong.streaming;
//
...
//						//如果userAdsClickLogRDD与blacklistRDD  join上了。就会生成这种格式  (zs , (zs 201009,some(true)))
//						//因为是Optional类型，所以就会返回some(true)类型
...
//												//tuple._2._2是blacklist里面的第二个值。true或者false
//
