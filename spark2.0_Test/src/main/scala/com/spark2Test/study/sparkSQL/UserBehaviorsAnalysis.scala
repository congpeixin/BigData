...
object UserBehaviorsAnalysis {
  //case class UserLog(logID: Long, userID: Long, time: Long, typed: Int, location: String, consumed: Double)
  ...
  def main(args: Array[String]): Unit = {
    ...
    val userLogjson = spark.read.json("D:\\userLog.json")
    val userInfojson = spark.read.json("D:\\userInfo.json")
